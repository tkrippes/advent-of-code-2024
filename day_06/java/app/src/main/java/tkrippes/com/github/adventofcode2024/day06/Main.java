...
import tkrippes.com.github.adventofcode2024.day06.solver.DistinctPositionsSolver;

public class Main {
    private static final String inputFileName = "../../input/input.txt";

    public static void main(String[] args) {
        System.out.println("Result of day 6 part 1: " + part1());
    }
    ...
    public static int part1() {
        ...
        return new DistinctPositionsSolver().solve(map);
    }
}
