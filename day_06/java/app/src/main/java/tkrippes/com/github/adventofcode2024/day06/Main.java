...
import tkrippes.com.github.adventofcode2024.day06.solver.VisitedGuardPositionsCountSolver;
...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println("Result of day 6 part 1: " + result(new VisitedGuardPositionsCountSolver()));
