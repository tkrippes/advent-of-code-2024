...
public class TwoOperationsTotalCalibrationResultSolverTest {
    private TwoOperationsTotalCalibrationResultSolver solver;

    @BeforeEach
    void setUp() {
        solver = new TwoOperationsTotalCalibrationResultSolver();
    }
